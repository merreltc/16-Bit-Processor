...
#endif
static const char *ng0 = "C:/Users/davissm/Desktop/csse232/1A-alfayeka-davissm-merreltc-smithlb/Implementation/Integration/Integration_ALU/Full_ALU_tb.v";
...
static unsigned int ng63[] = {32768U, 0U};
static unsigned int ng64[] = {32767U, 0U};
static const char *ng65 = "Test 16: Fail(It should with our current design, so this is a pass.)";
static const char *ng66 = "Test 16: Pass(This means our slt is robust and handles edge cases, sweet!)";
...
LAB139:    xsi_set_current_line(239, ng0);
    t2 = (t0 + 4432);
    xsi_process_wait(t2, 20000LL);
    *((char **)t1) = &&LAB140;
    goto LAB1;
